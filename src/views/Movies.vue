      ...
      <Row type="flex" justify="center" align="middle">
        ...
        <Col span="5">
          <Select
            ...
            :max-tag-count="2"
          >
            <Option value="popularity.desc">人氣</Option>
            <Option value="vote_average.desc">評分排行</Option>
            <Option value="primary_release_date.desc">上映日期</Option>
            <Option value="title.asc">名稱</Option>
          </Select>
        </Col>
      </Row>
    </form>
